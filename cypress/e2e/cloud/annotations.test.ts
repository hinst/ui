          ...
          .then(endTimeValue => {
            ...
            cy.getByTestID('startTime-testID')
              ...
              .then(startTimeValue => {
                ...
                const badEndTime = Cypress.moment(startTimeValue)
                  .subtract(1, 'minutes')
                  .format('YYYY-MM-DD hh:mm:ss a')
                ...
                const badEndTimeInFuture = Cypress.moment(startTimeValue)
                  .add(3, 'days')
                  .format('YYYY-MM-DD hh:mm:ss a')
                ...
                const badStartTimeInFuture = Cypress.moment(startTimeValue)
                  .add(3, 'days')
                  .format('YYYY-MM-DD hh:mm:ss a')
